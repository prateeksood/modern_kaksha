...
const sendEmail=async (otp,email)=>{
    try{
        ...
        let info = await transporter.sendMail({
            from: '"Delta Educators" <support@deltaeducators.com>',
            to: email, 
