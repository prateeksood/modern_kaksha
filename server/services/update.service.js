...
const updateTeacherAdService=async (data,callBack)=>{
    try{
        let result = await teacherDao.updateTeacherAd(data._id,data);
        return callBack(null, 200 , result);
    }catch(err){
        console.log(err);
        return callBack(err.message, 500)
...
const updateStudentAdService=async (data,callBack)=>{
    try{
        let result = await studentDao.updateStudentAd(data._id,data);
        return callBack(null, 200 , result);
    }catch(err){
        console.log(err);
        return callBack(err.message, 500)
...
const createOrderService = async (data, callBack)=>{
    ...
    const shasum = crypto.createHmac("sha256",'2qRnncJETXNzkNqr6UMkneLb' );
...
module.exports={updateTeacherService,updateStudentService,reviewUserService,createOrderService,updateOrderService, updateTeacherAdService, updateStudentAdService };